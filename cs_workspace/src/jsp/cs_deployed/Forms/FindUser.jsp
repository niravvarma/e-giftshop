...
<%-- <ics:logmsg msg="Inside FindUser CSElement......"/>
...
if(ics.GetVar("username")!=null){
	ics.SetVar("username",ics.GetVar("username"));
}
if(ics.GetVar("password")!=null){
	ics.SetVar("password",ics.GetVar("password"));
}
%>

<ics:setvar name="tablename" value="egsMember"/>

<%if(ics.GetVar("form-to-process")!=null && "LoginPost".equals(ics.GetVar("form-to-process"))){ %>
<ics:clearerrno/>
<ics:selectto table='<%=ics.GetVar("tablename")%>' what="*" listname='<%=ics.GetVar("listname")%>' where="username,password"/>
<ics:geterrno/>
<%} else { %>
<ics:clearerrno/>
<ics:selectto table='<%=ics.GetVar("tablename")%>' what="*" listname='<%=ics.GetVar("listname")%>' where="username"/>
<ics:geterrno/>
<%} %>
